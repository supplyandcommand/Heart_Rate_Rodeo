...
# crqa datasets
crqa_real <- read_csv("crqa_real_df.csv") %>%
...
```{r}
ggplot(crqa_HR, aes(condition, RR, color = reality_status, fill = reality_status)) +
  geom_jitter()

ggplot(crqa_resp, aes(condition, RR, color = reality_status, fill = reality_status)) +
  geom_jitter()
```
