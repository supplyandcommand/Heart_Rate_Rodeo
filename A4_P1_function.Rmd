...
optimizeBitch <- function(df, group_nr) {
  ...
  try(expr = (para_HR = optimizeParam(data_conv$hr1S, data_conv$hr2S, par, min.rec = 2, max.rec = 5)))
  try(expr = (para_RESP = optimizeParam(data_conv$resp1S, data_conv$resp2S, par, min.rec = 2, max.rec = 5)))
  try(expr = (para_ECG = optimizeParam(data_conv$ecg1S, data_conv$ecg1S, par, min.rec = 2, max.rec = 5)))
