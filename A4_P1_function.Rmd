...
# crqa datasets
crqa_real_df <- read_csv("crqa_real_df.csv")
...
```{r crqa real}
set.seed(666)
group_sync <- paste0("Synchronous_", c(1, 2, 4:9))
group_conv <- paste0("Conversation_", c(1, 2, 4:9))
group_turn <- paste0("TurnTaking_", c(1, 2, 4:9))

# loop trough all groups
crqa_hr <- map_df(GROUP,
                  crqa_real, 
                  df = d4,
                  var1 = "",
                  var2 = "",
